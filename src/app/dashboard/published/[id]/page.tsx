...
import { ImageIcon, X, Globe } from "lucide-react";
...
export default function Page(props: { params: { id: string } }) {
  ...
  const { title, setTitle: setTitleLocal, description, setDescription: setDescLocal, heroImage, setHeroImage: setHeroImageLocal, slug } = useEditorStore();
    ...
    <ScrollArea className="h-full w-full bg-background">
      <div className="container mx-auto max-w-4xl py-8 md:py-12 px-4 md:px-6">
        ...
        <div className="mb-6 flex items-center gap-3">
          <Badge variant="secondary" className="gap-1.5 px-3 py-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20">
        ...
        <div className="relative">
          <div className="absolute -left-4 top-0 bottom-0 w-px bg-gradient-to-b from-emerald-500/30 via-emerald-500/10 to-transparent hidden md:block" />
